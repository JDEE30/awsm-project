...
export default ({
  ...
  features = features || [
    ...
    `liscenced nurses and employers`,
    "Tons of locations",
    "always hiring",
      ...
      <Container tw="bg-gray-100 -mx-8 -mt-8 pt-8 px-8">
        <Content2Xl>
          ...
          <SectionContainer id="landingPageDemos">
            <SectionHeading>Remote - Onsite work.</SectionHeading> 
            <SectionDescription>
           
            Nurse practioners and Registered Nurses are encouraged to apply with our staffing agency.
            </SectionDescription>
            <PreviewCards>
          ...
          <SectionContainer>
            <SectionHeading>Liscenced Nurse Practioners</SectionHeading>
            <SectionDescription>
We want liscenced Nurse Practioners to apply to work for our staffing agency. 
We are a Texas based Staffing agency and we are hiring now. Check out our Nurse page, to fill out our short application process and someone will get back with you with in 24-48 hours. Our experience in the healthcare industry allows us to source only the best canidates for your hospital based work, private practice, group practice etc..
            </SectionDescription>
            <PreviewCards>
          ...
          <SectionContainer id="componentDemos">
            <SectionHeading>Nurse</SectionHeading>
            <SectionDescription>
We do all the work of making sure we only find the best Nurse Practitioners and Registered nurses to do the job right. See why Doctor's offices and private practices everywhere are contracting with our staffing agency today!<span tw="block text-sm text-gray-500 mt-2">
              </span>
            </SectionDescription>
